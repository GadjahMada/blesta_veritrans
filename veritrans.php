 ...
 *
 * @package blesta
 * @subpackage blesta.components.gateways.veritrans
 * @copyright Copyright (c) 2010, Phillips Data, Inc.
 * @license http://www.blesta.com/license/ The Blesta License Agreement
 * @link http://www.blesta.com/ Blesta
 */
class Veritrans extends NonmerchantGateway {
	/**
	 ...
	 */
	private static $authors = array(array('name' => "Ahmad Khairun", 'url' => "https://www.neutronhost.net"));
	/**
	...
	public function __construct() {
		...
		Language::loadLang("Veritrans", null, dirname(__FILE__) . DS . "language" . DS);
	}
	...
	public function getName() {
		return Language::_("Veritrans.name", true);
	}
		...
		$rules = array(
			'key'=>array(
				'valid'=>array(
					...
					'message'=>Language::_("Veritrans.!error.key.valid", true)
				)
			)
